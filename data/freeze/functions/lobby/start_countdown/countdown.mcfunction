...
execute unless score $Count countdown matches 0 run schedule function freeze:lobby/start_countdown/countdown 1s
execute if score $Count countdown matches 0 run function freeze:lobby/teams/start_team_select