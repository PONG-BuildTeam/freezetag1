...
execute at @s run data modify block ~ ~-1 ~ front_text.messages[0] set value '{"storage":"freeze:item_giver_time","nbt":"Temp"}'
execute at @s run data modify entity @s CustomName set from block ~ ~-1 ~ front_text.messages[0]
