...
execute as @e[type=snowball,tag=FTSnowball] run tellraw @a {"nbt":"Motion","entity":"@s"}
...
execute as @e[type=snowball,tag=FTSnowball] run function freeze:gameplay/general/items/snow/fix
