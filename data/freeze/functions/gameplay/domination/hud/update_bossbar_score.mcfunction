...
bossbar set minecraft:score name [{"translate":"offset.238","with":[{"text":"\uE000","font":"freeze:hud"}]},{"translate":"offset.-48","with":[{"storage":"freeze:hud","nbt":"top","interpret":true}]},{"translate":"offset.-286","with":[{"storage":"freeze:hud","nbt":"bottom","interpret":true}]}]
