execute at @s positioned ~-15.5 ~ ~-15.5 store result score $temp domination_score if entity @e[team=TeamRed,dx=30,dy=100,dz=30,tag=!FTFrozen,scores={freeze_grace=..0}]
