...
execute if entity @s[nbt={data:{Name:"Wet Cave"}}] run scoreboard players set $wet_cave_status domination_score 1
execute if entity @s[nbt={data:{Name:"Damp Valley"}}] run scoreboard players set $damp_valley_status domination_score 1
